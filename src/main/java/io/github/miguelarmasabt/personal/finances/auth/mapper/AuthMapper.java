...
public interface AuthMapper {
  ...
  default void fillUserEntityWithGoogleProfile(UserEntity user, GoogleIdentityRepository.GoogleIdentity googleIdentity) {
  ...
  default UserEntity toNewUserEntity(GoogleIdentityRepository.GoogleIdentity googleIdentity) {
