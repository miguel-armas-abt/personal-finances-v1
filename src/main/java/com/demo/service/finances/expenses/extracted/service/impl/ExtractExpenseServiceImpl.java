package com.demo.service.finances.expenses.extracted.service.impl;
...
import com.demo.service.finances.expenses.extracted.helper.GmailParameterHelper;
import com.demo.service.finances.expenses.extracted.mapper.ExtractExpenseMapper;
...
public class ExtractExpenseServiceImpl implements ExtractExpenseService {
  ...
  public Multi<ExtractExpenseResponseDto> getExtractedExpenses(String userCode) {
    return userActivityService.findOrPersist(userCode)
  ...
  private Uni<Void> updateLastSeenIfNeeded(String userCode,
    ...
    return expenses.stream()
        ...
        .map(newestDate -> userActivityService.update(userCode, newestDate))
